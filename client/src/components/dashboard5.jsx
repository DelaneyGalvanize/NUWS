...
export default class Dashboard5 extends React.Component {
  constructor(props) {
    super(props)
    ...
    componentDidMount() {
      ...
      $.ajax({
            ...
            url: `https://newsapi.org/v1/articles?source=techcrunch&sortBy=top&apiKey=5724121951714814964cebf967657080`,
  ...
  <Grid>
    <Row>
    <Col xs={6} md={3} >
      <Thumbnail className='tech'>
        {newsList[0]}
        <div><a className='techtitle' href={linked}>{title}</a></div>
      </Thumbnail>
    </Col>
    <Col xs={6} md={3}>
      <Thumbnail className='tech'>
        {newsList2[0]}
        <div><a className='techtitle' href={link2}>{title2}</a></div>
      </Thumbnail>
    </Col>
    <Col xs={6} md={3}>
      <Thumbnail className='tech'>
        {newsList3[0]}
        <div><a className='techtitle' href={link3}>{title3}</a></div>
      </Thumbnail>
    </Col>
    <Col xs={6} md={3}>
      <Thumbnail className='tech'>
        {newsList4[0]}
        <div><a className='techtitle' href={link4}>{title4}</a></div>
      </Thumbnail>
    </Col>
    </Row>
  </Grid>
